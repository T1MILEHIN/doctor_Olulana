...
const Home = () => {
    return (
        <div className="pt-16">
            ...
            <section className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-20 lg:py-32 overflow-hidden" style={{clipPath: 'polygon(0 0, 100% 0, 100% 85%, 0 100%)'}}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="animate-fade-in flex justify-center lg:justify-end">
                            <div className="relative group">
                                <div className="absolute -inset-4 bg-gradient-to-r from-blue-400 to-purple-400 rounded-full blur opacity-75 group-hover:opacity-100 transition duration-300"></div>
                                <img
            ...
            <div className="bg-gradient-to-brfrom-gray-50 via-blue-50 to-white">
                ...
                <section style={{clipPath: 'polygon(0 15%, 100% 0, 100% 85%, 0 100%)'}} id="appointment" className="py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-600 relative overflow-hidden">
                    <div className="absolute inset-0">
                    ...
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center">
                            <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100 px-10 py-4 text-lg rounded-xl shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 font-semibold">
                                Book Appointment
                            </Button>
                            <Button size="lg" variant="outline" className="text-white hover:bg-white hover:text-blue-600 bg-blue-600 px-10 py-4 text-lg rounded-xl backdrop-blur-sm transition-all duration-300 font-semibold">
                                Call (555) 123-4567
                            </Button>
                        </div>
                    </div>
